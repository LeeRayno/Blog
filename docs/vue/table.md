...
`el-table` 并没有提供 **拖拽** 功能, 所以需要自己实现, 去 [Issue](https://github.com/ElemeFE/element/issues/5684#issuecomment-459691810) 里面找到了如下方法
  ...
  render (h) {
    return (
      <div>
        ...
        { !this.hidePagenation && this.renderPaganition() }
      </div>
    )
  }
}
